...
const DropDownSingleEvent = ({ event }) => {

  
 
  return (
    <Link to={`/details/${event.id}`} className="dropdown">
    ...
    <div className="d-flex w-100 justify-content-between">
      <h5 className="mb-1">{event.title.slice(0, 20)}...</h5>
...
export default DropDownSingleEvent